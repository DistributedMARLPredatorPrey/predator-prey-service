...
class StandardAgentControllerTest(unittest.TestCase):
    ...
    @pytest.mark.description("The state of a prey should contain two distances less than the maximum visual depth,"
                             " corresponding to the intersection point with two predators")
    def test_state_distances(self):
